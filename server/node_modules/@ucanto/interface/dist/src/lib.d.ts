import { Ability, Block as UCANBlock, ByteView, Capabilities, Capability, DID, Fact, Link as UCANLink, MultihashHasher, MultihashDigest, MultibaseDecoder, MultibaseEncoder, Phantom, Resource, Signature, SignatureView, Principal, PrincipalView, MulticodecCode, SigAlg, ToJSON, SignatureJSON, JSONUnknown, Crypto, JSONObject } from '@ipld/dag-ucan';
import { Link, UnknownLink, Block as IPLDBlock, ToString, BlockEncoder } from 'multiformats';
import * as UCAN from '@ipld/dag-ucan';
import { CanIssue, Match, InvalidAudience, Unauthorized, UnavailableProof, DIDKeyResolutionError, ParsedCapability, CapabilityParser, Revoked, InferCapability, Authorization, Reader } from './capability.js';
import type * as Transport from './transport.js';
import type { Tuple, Block } from './transport.js';
export * from './capability.js';
export * from './transport.js';
export type { Transport, Phantom, Tuple, DID, Signature, SignatureView, ByteView, Capabilities, Capability, Fact, UCANBlock, UCANLink, Link, Link as IPLDLink, IPLDBlock, Block, Ability, Resource, SigAlg, MultihashDigest, MultihashHasher, MultibaseDecoder, MultibaseEncoder, MulticodecCode, Principal, PrincipalView, ToJSON, ToString, UnknownLink, JSONUnknown, Crypto, };
